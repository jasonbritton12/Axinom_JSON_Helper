#!/usr/bin/env python3
"""Generate Axinom ingest Excel template v1.5.0 with updated profiles and license times."""
...
OUTPUT_PATH = ROOT / "docs" / "reference" / "axinom_ingest_template_v1_5_0.xlsx"
