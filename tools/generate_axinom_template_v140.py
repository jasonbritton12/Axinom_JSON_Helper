#!/usr/bin/env python3
"""Generate Axinom ingest Excel template v1.4.0 with trailer/extra types."""
...
OUTPUT_PATH = ROOT / "docs" / "reference" / "axinom_ingest_template_v1_4_0.xlsx"
...
EXAMPLE_ROWS = [
    ...
    },
    {
        ...
        "License Start (UTC)": "2024-01-15 12:00 AM",
        "License End (UTC)": "2099-12-31 11:59 PM",
        "License Countries": "US",
