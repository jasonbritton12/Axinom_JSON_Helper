...
TEMPLATE_V1_5_3="$(resolve_file \
  "$ROOT_DIR/axinom_ingest_template_v1_5_3.xlsx" \
  "$ROOT_DIR/docs/reference/axinom_ingest_template_v1_5_3.xlsx")" || {
  echo "Missing template file: axinom_ingest_template_v1_5_3.xlsx"
  exit 1
}

TEMPLATE_V1_5_4="$(resolve_file \
  "$ROOT_DIR/axinom_ingest_template_v1_5_4.xlsx" \
  "$ROOT_DIR/docs/reference/axinom_ingest_template_v1_5_4.xlsx")" || {
  echo "Missing template file: axinom_ingest_template_v1_5_4.xlsx"
  exit 1
}
...
"$VENV_DIR/bin/pyinstaller" \
  ...
  --add-data "$TEMPLATE_V1_5_3:templates" \
  --add-data "$TEMPLATE_V1_5_4:templates" \
